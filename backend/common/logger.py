...
def get_logger(args):
    ...
    the Python logging module. It retrieves a logger instance named "bitlink21" and logs
    ...
    :type args: argparse.Namespace
    :return: A logger instance named "bitlink21".
    ...
    log = logging.getLogger("bitlink21")
